...
export default class extends Controller {
  ...
  toggle(event) {
    ...
    document.querySelectorAll(".workspace-thread-branch-menu-panel").forEach((el) => {
      el.hidden = true
    })
    document.querySelectorAll("[data-workspace-thread-branch-menu-target='trigger']").forEach((btn) => {
